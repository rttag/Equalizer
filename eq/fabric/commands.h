...
/** @cond IGNORE */
    ...
    {
        CMD_FRAMEDATA_READY = CMD_OBJECT_CUSTOM,
        CMD_FRAMEDATA_CREATE_RECEIVER,
        CMD_FRAMEDATA_CREATE_RECEIVER_REPLY,
        CMD_FRAMEDATA_PREPARE_UPLOAD,
        CMD_FRAMEDATA_CUSTOM = CMD_OBJECT_CUSTOM + 5
    };

    enum TransferNodeCommand
    {
        CMD_TRANSFERNODE_TRANSFER_IMAGE = CMD_OBJECT_CUSTOM,
        CMD_TRANSFERNODE_CUSTOM = CMD_OBJECT_CUSTOM + 5
    };

    enum TransferNodeSharedMemoryCommand
    {
        CMD_TRANSFERNODE_SHAREDMEM_CLEAR = CMD_TRANSFERNODE_CUSTOM,
        CMD_TRANSFERNODE_SHAREDMEM_CLEAR_REPLY,
        CMD_TRANSFERNODE_SHAREDMEM_MAPMEM,
        CMD_TRANSFERNODE_SHAREDMEM_MAPMEM_REPLY,
        CMD_TRANSFERNODE_SHAREDMEM_CUSTOM = CMD_TRANSFERNODE_CUSTOM + 10
    };
/** @endcond */
}
}
